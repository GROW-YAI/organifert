...
//         {/* Dynamic Breadcrumb */}
//         {showBreadCrumb && (
//           <div className="bg-gray-100 p-1 shadow-sm  mt- w-full max-w-full">
//             <Breadcrumb />
//           </div>
//         )}
  ...
  return (
    <Container className="pb-12 pt-0">
      <MainContent>
        {/* Dynamic Breadcrumb */}
        {showBreadCrumb && (
          <div className="p-1 mt-22 w-full max-w-full">
            <Breadcrumb />
          </div>
        )}
